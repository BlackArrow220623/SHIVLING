        ...
        return (
            <View style={{ flex: 1, backgroundColor: colors.primary }}>
                <ScrollView>
                    ...
                    <View style={{ display: "flex", padding: "10rem", margin: 10 }}>
                        ...
                        <View style={{ flex: 1, flexDirection: "row", paddingHorizontal: 12 }}>
                            ...
                            <View style={{ flex: 1, alignItems: "flex-end" }}>
                                <View style={{}}>
                                    <TouchableOpacity onPress={this.forgotPasswordHandling}>
                                        <Text style={{ color: colors.sandal, paddingVertical: 10 }}>{Labels.login.superAdmin}</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>
